      subroutine smearing_nl(ismear,rhisto_in,x,inbins,rbinsize,rEres1,rEres2,rhisto_out)
C     ****************************************************
C     By Yoshitaro Takaesu @KIAS Sep.7 2012
C                 Modified @KIAS May.17 2013     
C     ****************************************************
      implicitnone
C     
C     ARGUMENTS 
C     
      integer inbins,ismear
...
C     ----------
      do i = 1,inbins
         rhisto_out(i) = 0d0
      enddo
      if ((rEres1.eq.0).and.(rEres2.eq.0)) ismear = 0
      if (ismear.eq.0) then
         do i = 1,inbins
     ...
     &              *( rhisto_in(i+j) +rhisto_in(i-j) )
      ...
      subroutine smearing_nl2(ismear,rhisto_in,x,inbins,rEres1,rEres2,rhisto_out)
C     ****************************************************
