...
c     E: incoming neutrino energy in GeV
      ...
      real*8 function pi0mom_ne(icol,Ev,Erec)
c     Erec: Reconstructed neutrino energy [MeV]
c     Ev: incoming neutrino energy [MeV]
      implicit none
      integer oi
      include 'include_pi0momincs_ne1100.inc'
      real*8 Ev,Erec
      character*5 cEv4
      integer i
...
c      icol = 2
      ...
      include 'inc/read_pi0mominc_ne1100.inc'
      pi0mom_ne = f
      return
      end
...
c      icol = 2
      ...
      real*8 function pi0mom_ae(icol,Ev,Erec)
c     Erec: Reconstructed neutrino energy [MeV]
c     Ev: incoming neutrino energy [MeV]
      implicit none
      integer oi
      include 'include_pi0momincs_ae1100.inc'
      real*8 Ev,Erec
      character*5 cEv4
      integer i
      integer nrow,ncol,icol,inum,iEv
...
c      icol = 2
      binw = 1d0 ! table is for dist probability, not for events/bin_width
      include 'inc/read_pi0mominc_ae1100.inc'
      pi0mom_ae = f
      return
      end
