...
c     E: incoming neutrino energy in GeV
      ...
      real*8 function pi0mom_old_ne(icol,Ev,Erec)
c     Erec: Reconstructed neutrino energy [MeV]
c     Ev: incoming neutrino energy [MeV]
      implicit none
      integer oi
      include 'include_pi0mom_oldincs_ne1100.inc'
      real*8 Ev,Erec
      character*5 cEv4
      integer i
...
c      icol = 2
      ...
      include 'inc/read_pi0mom_oldinc_ne1100.inc'
      pi0mom_old_ne = f
      return
      end
...
c      icol = 2
      ...
      real*8 function pi0mom_old_ae(icol,Ev,Erec)
c     Erec: Reconstructed neutrino energy [MeV]
c     Ev: incoming neutrino energy [MeV]
      implicit none
      integer oi
      include 'include_pi0mom_oldincs_ae1100.inc'
      real*8 Ev,Erec
      character*5 cEv4
      integer i
      integer nrow,ncol,icol,inum,iEv
...
c      icol = 2
      binw = 1d0
      include 'inc/read_pi0mom_oldinc_ae1100.inc'
      pi0mom_old_ae = f
      return
      end
